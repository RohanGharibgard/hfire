          ...
          for (cell_az = 0; cell_az < EIGHTNBR_NUM_NBR_CELLS; cell_az++) 
          {
            ...
            case EnumHasFireCellState:
              ...
              if ( nbr_brn_cell != NULL  && nbr_brn_cell->max_rosmps > 0.0 )
              {
                ...
                {
                case 0:
                  //brn_cell->distm[7] += nbr_brn_cell->rosmps[6] * iter_secs;
                  //brn_cell->distm[1] += nbr_brn_cell->rosmps[2] * iter_secs;
                  break;
                case 1:
                  brn_cell->distm[0] += nbr_brn_cell->rosmps[6] * iter_secs;
                  brn_cell->distm[2] += nbr_brn_cell->rosmps[4] * iter_secs;
                  break;
                case 2:
                  //brn_cell->distm[1] += nbr_brn_cell->rosmps[0] * iter_secs;
                  //brn_cell->distm[3] += nbr_brn_cell->rosmps[4] * iter_secs;
                  break;
                case 3:
                  brn_cell->distm[2] += nbr_brn_cell->rosmps[0] * iter_secs;
                  brn_cell->distm[4] += nbr_brn_cell->rosmps[6] * iter_secs;
                  break;
                case 4:
                  //brn_cell->distm[3] += nbr_brn_cell->rosmps[2] * iter_secs;
                  //brn_cell->distm[5] += nbr_brn_cell->rosmps[6] * iter_secs;
                  break;
                case 5:
                  brn_cell->distm[4] += nbr_brn_cell->rosmps[2] * iter_secs;
                  brn_cell->distm[6] += nbr_brn_cell->rosmps[0] * iter_secs;
                  break;
                case 6:
                  //brn_cell->distm[5] += nbr_brn_cell->rosmps[4] * iter_secs;
                  //brn_cell->distm[7] += nbr_brn_cell->rosmps[0] * iter_secs;
                  break;
                case 7:
                  brn_cell->distm[6] += nbr_brn_cell->rosmps[4] * iter_secs;
                  brn_cell->distm[0] += nbr_brn_cell->rosmps[2] * iter_secs;
                  break;
                }
              }
#endif
